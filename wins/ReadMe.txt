========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : wins
========================================================================


Diese wins-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\wins.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei wins.rc eingebunden.
...
winsDlg.h, winsDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CWinsDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in wins.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	wins.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
